  ...
  useEffect(() => {
    if (previousProps?.profileData !== profileData) {
      if (profileData) {
        ...
        const array4 = []
        array.push(
          `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.pan_file}`
        )
        array2.push(
          `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.adhar_card_number_front}`
        )
        array3.push(
          `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.adhar_card_number_back}`
        )
        array4.push(
          `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.signature}`
        )
        setBackImage(array)
        setAFront(array2)
        setABack(array3)
                        ...
                        <img
                          src={
                            ...
                            profileData?.details?.profile_picture ===
                              'undefined'
                              ? defaultPic
                              : `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.profile_picture}`
                          }
                          alt=''
                        />
                      </div>
                    ...
                    <div className='col-xl-4 '>
                      <div className=''>
                        ...
                        <div className='aadhar-box d-flex flex-wrap'>
                          <img
                            className='m-0'
                            src={`${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.pan_file}`}
                            alt='ollato-img'
                  ...
                  <div className='row'>
                    ...
                    <div className='col-xl-4 '>
                      <div className=''>
                        ...
                        <div className='aadhar-box d-flex flex-wrap'>
                          <img
                            src={`${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.adhar_card_number_front}`}
                    ...
                    <div className='col-xl-4 '>
                      <div className=''>
                        ...
                        <div className='aadhar-box d-flex flex-wrap'>
                          <img
                            src={`${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.adhar_card_number_back}`}
                  ...
                  <div className='row'>
                    ...
                    <div className='col-xl-4 '>
                      <div className=''>
                        ...
                        <div className='aadhar-box d-flex flex-wrap'>
                          <img
                            src={`${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.signature}`}
