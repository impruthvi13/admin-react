                  ...
                  <div className='col-md-4 order-1 order-md-0 mb-3 mb-md-0'>
                    <div className='profileinfo profile-updated'>
                      <div className='profile-img'>
                        <img
                              src={profileData?.details?.profile_picture === null || profileData?.details?.profile_picture === 'undefined' ? defaultPic : `${process.env.REACT_APP_AXIOS_BASE_URL}${profileData?.details?.profile_picture}`}
                              alt=''
                            />
                      </div>
                    </div>
