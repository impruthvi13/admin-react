...
function ViewCounsellor() {
  ...
  const previousProps = useRef({ mainData }).current
  ...
  useEffect(() => {
    if (previousProps?.mainData !== mainData) {
      if (mainData) {
        const array = []
        const array2 = []
        const array3 = []
        const array4 = []
        if (mainData?.counsellorDetail?.pan_file !== null) {
          array.push(`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.pan_file}`)
        }
        if (mainData?.counsellorDetail?.adhar_card_number_front !== null) {
          array2.push(`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.adhar_card_number_front}`)
        }
        if (mainData?.counsellorDetail?.adhar_card_number_back !== null) {
          array3.push(`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.adhar_card_number_back}`)
        }
        if (mainData?.counsellorDetail?.signature !== null) {
          array4.push(`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.signature}`)
        }
        setPancard(array)
        setAFront(array2)
        setABack(array3)
    ...
    return () => {
      previousProps.mainData = mainData
    }
  }, [mainData])
                            ...
                            <div className=''>
                              ...
                              >
                                {mainData?.counsellorDetail?.pan_file !== null ? (
                                  <img
                                    className='m-0'
                                    src={`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.pan_file}`}
                                    alt='ollato-img'
                          ...
                          <div className='col-xl-4 '>
                            <div className=''>
                              ...
                              >
                                {mainData?.counsellorDetail?.adhar_card_number_front !== null ? (
                                  <img
                                    src={`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.adhar_card_number_front}`}
                          ...
                          <div className='col-xl-4 '>
                            <div className=''>
                              ...
                              >
                                {mainData?.counsellorDetail?.adhar_card_number_back !== null ? (
                                  <img
                                    src={`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.adhar_card_number_back}`}
                            ...
                            <div className=''>
                              ...
                              >
                                {mainData?.counsellorDetail?.signature !== null ? (
                                  <img
                                    src={`${process.env.REACT_APP_AXIOS_BASE_URL}${mainData?.counsellorDetail?.signature}`}
